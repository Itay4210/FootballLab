...
export const PlayerProfile = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 animate-fade-in">
      <Link
        to="/"
        className="text-slate-400 hover:text-white mb-6 inline-block font-bold text-sm uppercase tracking-wider"
      >
        ← Back to Dashboard
      </Link>
      <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-8 shadow-2xl">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8 border-b border-slate-800 pb-8">
          <div>
            ...
            <div className="flex items-center gap-3">
              <span className="bg-lab-accent text-lab-dark px-3 py-1 rounded font-bold text-sm">
                {player.position}
              </span>
        ...
        <div className="bg-slate-900 rounded-lg overflow-hidden border border-slate-800">
            ...
            <tbody className="divide-y divide-slate-800">
              {statsHistory.map((s) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-center font-bold text-lab-accent text-lg">
                    {s.goals}
                  </td>
                  <td className="px-6 py-4 text-center font-bold text-blue-400 text-lg">
                    {s.assists}
                  </td>
              ...
              {statsHistory.length === 0 && (
                <tr>
                  <td
                    colSpan={6}
                    className="px-6 py-8 text-center italic text-slate-600"
                  >
          ...
          <div className="p-2 text-[10px] text-slate-600 italic text-right">
